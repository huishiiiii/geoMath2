...
class ManageNotesTabPage extends StatefulWidget {
  static const routeName = 'manage_notes';
  final void Function(int, String?)? onTabSelected;
  const ManageNotesTabPage({Key? key, this.onTabSelected}) : super(key: key);

  @override
  State<ManageNotesTabPage> createState() => _ManageNotesPageState();
}

class _ManageNotesPageState extends State<ManageNotesTabPage> {
                        ...
                        if (index == 0 &&
                          ...
                          return CustomManageNoteButton(
                            ...
                            onPressed: () {
                              ...
                              Navigator.of(context)
                                  .pushNamed(AddNewNotePage.routeName);
                            },
                          );
                        } else {
                          ...
                          return CustomManageNoteButton(
                            ...
                            onPressed: () {
                              ...
                              widget.onTabSelected!(9, classId);
