...
Future<void> showDeleteNoteConfirmationDialog(BuildContext context,
    NoteModel noteModel, String oldTitle, String oldClassId) {
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        firebaseService.deleteNote(
                            noteModel, oldTitle, oldClassId);
                        Navigator.of(context).pop();
                        Navigator.of(context).pop();
                        Navigator.of(context).maybePop();
                        showCustomSnackBar(
                            context, TextConstant.noteSuccessfullyDeleted);
                      },
